...
class ASFF(nn.Module):
    def __init__(self, level, expansion, rfb=False, vis=False):
        ...
        self.DoubleAttention_level0 = DoubleAttentionLayer(self.inter_dim, self.inter_dim//2, self.inter_dim//2)
        self.DoubleAttention_level1 = DoubleAttentionLayer(self.inter_dim, self.inter_dim//2, self.inter_dim//2)
        self.DoubleAttention_level2 = DoubleAttentionLayer(self.inter_dim, self.inter_dim//2, self.inter_dim//2)
    ...
    def forward(self, x_level_0, x_level_1, x_level_2):
        ...
        level_0_se = self.DoubleAttention_level0(level_0_resized)
        level_1_se = self.DoubleAttention_level1(level_1_resized)
        level_2_se = self.DoubleAttention_level2(level_2_resized)
...
class ResNet(nn.Module):
  def __init__(self, block, layers, num_classes=2):
    ...
    self.DoubleAttention_layer4 = DoubleAttentionLayer(512 * block.expansion, 512 * block.expansion//2,512 * block.expansion//2)
  ...
  def forward(self, x):
    ...
    x = self.layer4(x)
    x = self.DoubleAttention_layer4(x)
    x = x + x_res
